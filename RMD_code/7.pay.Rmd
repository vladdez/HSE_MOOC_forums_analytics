...
- **Посещение форума.**
  ...
  - ***vis_p_n*** - нормализованное количество посещенных страниц = число посещенных страний / среднее чсило посещенных страниц на курсе;
- **Тип курса.**     
...
Выбор статистических инструментов:
    ...
    - Для обратной трансфорации мы используем функцию invlogit().
...
## Выводы
    ...
    5. Вероятность, что студент оплатит курс, увеличвается в 1.1 раз при каждом посещении форума
