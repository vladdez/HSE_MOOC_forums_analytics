...
cat(sprintf("Изменение на 1 пункт в выживаемости курса изменяет на %.3f пунктов среднее количество посещений форума.\n", m1$coefficients[2]))
...
## 4. Влияние типа курса и выживаеммости на посещение форума
